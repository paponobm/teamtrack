...
const navItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { labelKey: 'nav.finance', href: '/expenses', icon: 'expense', slugs: ['finance'], adminOnly: false },
            { labelKey: 'Product Buy', href: '/advance-management', icon: 'productBuy', slugs: ['product-buy'], adminOnly: false },
            { labelKey: 'Payroll Management', href: '/payroll-management', icon: 'payroll', slugs: ['payroll-management'], adminOnly: false },
            ...
            { labelKey: 'nav.aboutUs', href: '/about-us', icon: 'aboutUs', slugs: null, adminOnly: false },
        ]
    },
    {
...
function NavIcon({ type }: { type: string }) {
    const icons: Record<string, React.ReactElement> = {
        ...
        aboutUs: (<svg viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 16V4a1 1 0 011-1h6a1 1 0 011 1v3h3a1 1 0 011 1v8h1a1 1 0 110 2H3a1 1 0 110-2h1zm3-9a1 1 0 000 2h1a1 1 0 100-2H7zm0 4a1 1 0 100 2h1a1 1 0 100-2H7zm4-4a1 1 0 000 2h1a1 1 0 100-2h-1zm0 4a1 1 0 100 2h1a1 1 0 100-2h-1zm2 4a1 1 0 00-1 1v1h2v-1a1 1 0 00-1-1z" clipRule="evenodd" /></svg>),
