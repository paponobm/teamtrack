...
function NavIcon({ type }: { type: string }) {
    const icons: Record<string, React.ReactElement> = {
        ...
        advance: (<svg viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M2 6a2 2 0 012-2h12a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6zm10 5a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" /><path d="M4 4a1 1 0 00-1 1v3a1 1 0 001 1h1a2 2 0 002-2V6a2 2 0 00-2-2H4zM16 6a2 2 0 00-2-2h-1a1 1 0 00-1 1v2a2 2 0 002 2h1a1 1 0 001-1V6z" /></svg>),
