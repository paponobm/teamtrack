...
export default function WorkLogPage() {
    ...
    const [stats, setStats] = useState<Stats>({ totalOrders: 0, totalAmount: 0, totalAdvance: 0, sources: {}, orderTypes: {}, statusBreakdown: {} })
    ...
    const fetchEntries = useCallback(async () => {
        ...
        setLoading(false)
    }, [date, dateRangeMode, customStart, customEnd, filterEmployee, filterOrderType, filterSource, filterStatus])
